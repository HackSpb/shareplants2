(function ($) {
    ...
    $('.slider-range-price').each(function () {
        ...
        let label_result = jQuery(this).data('label-result');
        let  input_min_id =  jQuery(this).data('input-min-id');
        let input_max_id =  jQuery(this).data('input-max-id');
        let t = $(this);
        $(this).slider({
            range: true,
            min: min,
            ...
            slide: function (event, ui) {
                ...
                $('#'+input_min_id).val(ui.values[0]);
                $('#'+input_max_id).val(ui.values[1]);
                console.log('#'+input_min_id, ui.values[0]);
